...
You can install the development version of regexcitehan from
[GitHub](https://github.com/) with:

``` r
# install.packages("pak")
pak::pak("hanwang205/regexcitehan")
```
...
That’s exactly what `regexcitehan::str_split_one()` does.

``` r
library(regexcitehan)
